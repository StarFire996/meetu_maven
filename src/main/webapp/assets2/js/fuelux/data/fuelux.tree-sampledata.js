...
var tree_data = {
	'city' : {name: '济南市', type: 'folder'}
}
tree_data['city']['additionalParameters'] = {
	'children' : {
		'weishengju' : {name: '卫生局', type: 'item'},
		'huanbaoju' : {name: '环保局', type: 'item'},
		'kejiju' : {name: '科技局', type: 'item'},
		'wenhuaju' : {name: '文化局', type: 'item'}
	}
}
