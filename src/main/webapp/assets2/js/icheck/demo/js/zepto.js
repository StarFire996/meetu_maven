...
var Zepto = function() {
    ...
    function A(a) {
        return "children" in a ? B.call(a.children) : c.map(a.childNodes,
        function(a) {
    ...
    I = {},
    H = {},
    J = v.defaultView.getComputedStyle,
    M = {
        "column-count": 1,
        columns: 1,
        "font-weight": 1,
    ...
    O = /^(?:body|html)$/i,
    U = "val css html text data width height offset".split(" "),
    K = v.createElement("table"),
    ...
    n.matches = function(a, b) {
        ...
        var c;
        c = a.parentNode; (d = !c) && (c = R).appendChild(a);
    ...
    n.init = function(a, b) {
        if (a) {
            ...
            else if (q(a)) d = [k(a) ? c.extend({},
            a) : a],
            a = null;
            else if (N.test(a)) d = n.fragment(a.trim(), RegExp.$1, b),
            a = null;
            else {
    ...
    c.map = function(a, b) {
        var d, e = [],
        f;
        if (l(a)) for (f = 0; f < a.length; f++) d = b(a[f], f),
        null != d && e.push(d);
        else for (f in a) d = b(a[f], f),
        null != d && e.push(d);
        return 0 < e.length ? c.fn.concat.apply([], e) : e
    };
    c.each = function(a, b) {
        var d;
        if (l(a)) for (d = 0; d < a.length && !1 !== b.call(a[d], d, a[d]); d++);
    ...
    c.fn = {
        ...
        ready: function(a) {
            V.test(v.readyState) ? a(c) : v.addEventListener("DOMContentLoaded",
            function() {
                a(c)
            },
            !1);
        ...
        filter: function(a) {
            return m(a) ? this.not(this.not(a)) : c(D.call(this,
            function(b) {
        ...
        closest: function(a, b) {
            var d = this[0],
            e = !1;
            for ("object" == typeof a && (e = c(a)); d && !(e ? 0 <= e.indexOf(d) : n.matches(d, a));) d = d !== b && !s(d) && d.parentNode;
            return c(d)
        },
        parents: function(a) {
            for (var b = [], d = this; 0 < d.length;) d = c.map(d,
            function(a) {
                if ((a = a.parentNode) && !s(a) && 0 > b.indexOf(a)) return b.push(a),
                a
            });
            return y(b, a)
        },
        ...
        wrapInner: function(a) {
            ...
            return this.each(function(d) {
                ...
                f = e.contents();
                d = b ? a.call(this, d) : a;
                f.length ? f.wrapAll(d) : e.append(d)
            })
        },
        unwrap: function() {
        ...
        toggle: function(a) {
            return this.each(function() {
                var b = c(this); (a === f ? "none" == b.css("display") : a) ? b.show() : b.hide()
            })
        },
        prev: function(a) {
        ...
        attr: function(a, b) {
            ...
            return "string" == typeof a && b === f ? 0 == this.length || 1 !== this[0].nodeType ? f: "value" == a && "INPUT" == this[0].nodeName ? this.val() : !(d = this[0].getAttribute(a)) && a in this[0] ? this[0][a] : d: this.each(function(d) {
                ...
                } else d = x(this, b, d, this.getAttribute(a)),
        ...
        css: function(a, b) {
            ...
            }) : d = j(a) + ":" + ("number" == typeof b && !M[j(a)] ? b + "px": b);
            else for (g in a) ! a[g] && 0 !== a[g] ? this.each(function() {
        ...
        toggleClass: function(a, b) {
            return this.each(function(d) {
                var e = c(this);
                x(this, a, d, z(this)).split(/\s+/g).forEach(function(a) { (b === f ? !e.hasClass(a) : b) ? e.addClass(a) : e.removeClass(a)
                })
            })
        },
        scrollTop: function() {
    ...
    c.fn.detach = c.fn.remove; ["width", "height"].forEach(function(a) {
        c.fn[a] = function(b) {
            ...
            return b === f ? p(e) ? e["inner" + g] : s(e) ? e.documentElement["offset" + g] : (d = this.offset()) && d[a] : this.each(function(d) {
                e = c(this);
...
"$" in window || (window.$ = Zepto); (function(h) {
    ...
    Array.prototype.reduce === h && (Array.prototype.reduce = function(m) {
        ...
        for (; q < s;) q in p && (k = m.call(h, k, p[q], q, p)),
        q++;
        return k
    })
})(); (function(h) {
    ...
    function k(e, f, g, c, u, l) {
        ...
        function(f, g) {
            ...
            var k = j.del || g;
            j.proxy = function(c) {
                var f = k.apply(e, [c].concat(c.data)); ! 1 === f && (c.preventDefault(), c.stopPropagation());
                return f
            };
            j.i = r.length;
            r.push(j);
    ...
    h.Event = function(e, f) {
        ...
        var g = document.createEvent(A[e] || "Events"),
        c = !0;
    ...
    q = h.fn.data,
    k = h.camelCase,
    t = h.expando = "Zepto" + +new Date;
    h.fn.data = function(l, j) {
